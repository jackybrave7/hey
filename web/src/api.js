...
export const api = {
  ...
  updateScheduledMessage: (id, body) => req('PATCH', `/scheduled/${id}`, body),
  ...
  adminSystemListOrphans:     ()           => req('GET',    '/admin/system/orphan-messages'),
  adminSystemDeleteMessage:   (id)         => req('DELETE', `/admin/system/messages/${id}`),
  adminSystemListOnboarding:  ()           => req('GET',    '/admin/system/onboarding'),
  adminSystemCreateOnboarding: (data)      => req('POST',   '/admin/system/onboarding', data),
  adminSystemUpdateOnboarding: (id, data) => req('PATCH',  `/admin/system/onboarding/${id}`, data),
  adminSystemDeleteOnboarding: (id)       => req('DELETE', `/admin/system/onboarding/${id}`),
  ...
  adminS3DeleteObject:     (key)           => req('DELETE', '/admin/s3/object', { key, confirm: 'DELETE_S3_OBJECT' }),
  adminS3DeleteObjects:    (keys)          => req('POST',   '/admin/s3/objects/delete', { keys, confirm: 'DELETE_S3_OBJECTS' }),
  ...
  adminGetWaitlistEmailTemplate: ()          => req('GET',    '/admin/waitlist/email-template'),
  adminSaveWaitlistEmailTemplate: (data)     => req('PATCH',  '/admin/waitlist/email-template', data),
  adminResetWaitlistEmailTemplate: ()        => req('POST',   '/admin/waitlist/email-template/reset'),
