  ...
  return (
    <div style={{ padding: '28px 32px', maxWidth: 1400 }}>
      ...
      <p style={{ color: 'rgba(249,240,240,.45)', fontSize: 13, marginTop: 0, marginBottom: 18 }}>
        ...
        момент или аватар не ссылается. Ручное удаление здесь работает сразу;
        автоматический sweep по-прежнему только в dry-run, пока на сервере не выставлен S3_SWEEP_ALLOW_DELETE=1.
      </p>
