    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'linear-gradient(90deg, rgba(200,160,255,.18), rgba(95, 64, 128,.18))',
          border: '1px solid rgba(200,160,255,.25)',
          borderRadius: 50, padding: '3px 10px',
        }}>
          <HeyLogo size={13} color="rgba(220,180,255,.95)" />
        ...
        <span style={{ color: 'rgba(249,240,240,.28)', fontSize: 11 }}>
        ...
        {canPrev && (
          <button
            ...
            style={{
              ...
              color:'#F9F0F0', fontSize: 18, display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          {moments.map((_, i) => (
            <div
              ...
              style={{
                ...
                background: i === idx ? 'rgba(180,140,220,.9)' : 'rgba(249,240,240,.25)',
      ...
      {isMine && moments.length > 1 && (
        <div style={{
          ...
          <button
            ...
            disabled={!canPrev}
            style={{
              background: canPrev ? 'rgba(249,240,240,.08)' : 'transparent',
              border: '1px solid rgba(249,240,240,.1)', borderRadius: 50,
              padding: '4px 14px', color: canPrev ? 'rgba(249,240,240,.7)' : 'rgba(249,240,240,.2)',
              fontSize: 12, cursor: canPrev ? 'pointer' : 'default', transition: 'all .15s',
            }}
          >← Переместить</button>
          <span style={{ color: 'rgba(249,240,240,.3)', fontSize: 11 }}>порядок</span>
          <button
            onClick={moveRight}
            disabled={!canNext}
            style={{
              background: canNext ? 'rgba(249,240,240,.08)' : 'transparent',
              border: '1px solid rgba(249,240,240,.1)', borderRadius: 50,
              padding: '4px 14px', color: canNext ? 'rgba(249,240,240,.7)' : 'rgba(249,240,240,.2)',
