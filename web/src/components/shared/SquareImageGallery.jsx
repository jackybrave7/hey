 ...
 */
function GalleryImage({ src, native, onClick, onPointerDown, style, passPointerToParent }) {
  const imgStyle = {
    width: '100%',
    height: '100%',
    objectFit: 'cover',
  ...
  if (native) {
    return <img src={src} alt="" onClick={onClick} onPointerDown={onPointerDown} style={imgStyle} draggable={false} />;
  }
  return (
    <MediaImage
      src={src}
