...
// ─────────────────────────────────────────────────────────────────────────────
function AvatarCropperModal({ file, onCancel, onDone }) {
        ...
        <div style={{ display:'flex', gap:8, marginTop:16 }}>
          <button onClick={onCancel} disabled={saving}
            style={{ flex:1, padding:'12px', borderRadius:12, border:'none',
              background:'rgba(255,255,255,.1)', color:'white', fontSize:14, fontWeight:600,
              cursor: saving ? 'wait' : 'pointer', fontFamily:'inherit' }}>
            Отмена
          </button>
          <button onClick={handleDone} disabled={saving || !imgLoaded}
            style={{ flex:1, padding:'12px', borderRadius:12, border:'none',
              background:'rgba(140,110,220,.85)', color:'white', fontSize:14, fontWeight:700,
