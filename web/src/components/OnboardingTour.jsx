...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Это не «лайк» и не сразу «написать в чат».\n\nЭто метка для тебя самого: момент важный, хочется обсудить с автором — но не прямо сейчас.\n\nВсе такие моменты собираются в разделе «🤝 Поговорить» в твоём профиле — чтобы вернуться когда будет время.',
  },
  {
    icon: '🔒',
